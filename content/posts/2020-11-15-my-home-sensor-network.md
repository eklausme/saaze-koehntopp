...
- [Plugs with Wi-Fi](../2020-05-12-plugs-with-wifi): In which I am asking what kind of power plug to use to collect usage data.
- [Gosund and Tasmota](../2020-05-20-gosund-and-tasmota): In which I describe how to convert Gosund SP 111 plugs to Tasmota.
- [Air Quality Sensors](../2020-05-25-air-quality-sensors): In which I ask for Air Quality sensors, specifically with CO2 level metrics.
...
![](https://blog.koehntopp.info/uploads/2020/11/iot-conbee.jpg)
...
![](https://blog.koehntopp.info/uploads/2020/11/iot-aqara1.jpg)
...
![](https://blog.koehntopp.info/uploads/2020/11/iot-aqara2.jpg)
...
I bought a very large number of [Gosund SP111 Wall Plugs](https://www.amazon.de/gp/product/B085RFKVW4) and converted them to Tasmota [using Tuya-Convert](../2020-05-20-gosund-and-tasmota). The plugs are attractive, because they can do the full 16A and are small enough to fit next to each other on a regular plug extender, if the slots are angled at 45deg (the device has a button, and the Gosund plugs are touching each other on small extenders, pressing each other's button).
...
[![](https://blog.koehntopp.info/uploads/2020/11/iot-mesh.png)](https://blog.koehntopp.info/uploads/2020/11/iot-mesh-large.png)
